...
# roslaunch hydrone_aerial_underwater_ddpg deep_RL_2D.launch ep:=0 file_dir:=sac_stage_1_air2D_tanh_2layers deep_rl:=sac_air2D_tanh_2layers.py world:=stage_1_aerial root_dir:=/home/ricardo/ graphic_int:=fals