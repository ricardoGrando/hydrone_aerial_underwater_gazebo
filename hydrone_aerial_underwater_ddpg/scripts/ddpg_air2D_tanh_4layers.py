...
# roslaunch hydrone_aerial_underwater_ddpg deep_RL_2D.launch ep:=0 file_dir:=ddpg_stage_1_air2D_tanh_4layers deep_rl:=ddpg_air2D_tanh_4layers.py world:=stage_1_aerial root_dir:=/home/ricardo/ graphic_int:=false